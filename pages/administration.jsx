        ...
        <div className="flex flex-col md:flex-row items-center justify-center w-5/6 sm:w-4/6 md:w-2/3 xl:w-1/2">
          <Link href="/administration/users">
            <a
              ...
              className="flex items-center justify-center rounded-lg w-full md:w-1/2 py-4 m-3 text-sm sm:text-lg bg-blue-500 text-white transition-all hover:scale-105 hover:drop-shadow-xl focus:outline focus:outline-3 focus:outline-blue-500/75"
            >
